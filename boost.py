...
class BoostCardExtractor:
    ...
    def __init__(self, session: requests.Session):
        ...
        """
        self.session = session
        self.member_parser = ClubMemberParser(session)  # 🆕 Добавили парсер участников
    ...
    def get_card_info(self, boost_url: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            # 🆕 НОВОЕ: Парсим участников клуба с этой картой
            ...
            return {
                ...
                "club_members": club_members  # 🆕 Список участников клуба
            }
...
def format_club_members_info(members: List[Dict[str, str]]) -> str:
    """
    🆕 НОВОЕ: Форматирует информацию об участниках клуба.
