...
# 🔧 ИСПРАВЛЕНО: Настройки Telegram
TELEGRAM_ENABLED = True  # Включить/выключить уведомления
TELEGRAM_BOT_TOKEN = "8300878628:AAFe4N9HqfrZWt7ncdJZCSlGQbFjoUXAr7U"  # Токен бота

# 🔧 ВАЖНО: Для приватных групп (ссылки вида t.me/c/...)
# Нужен CHAT_ID в формате -100xxxxxxxxxx
# Для ссылки https://t.me/c/2234810541/728886:
# - Берем число после /c/: 2234810541
# - Добавляем префикс -100: -1002234810541
TELEGRAM_CHAT_ID = "-1002234810541"  # 🔧 ИСПРАВЛЕНО: Формат для приватных групп

# 🔧 ИСПРАВЛЕНО: Thread ID (ID темы/топика)
# Для ссылки https://t.me/c/2234810541/728886
# Thread ID = 728886 (число после последнего слеша)
TELEGRAM_THREAD_ID = 728886  # 🔧 ИСПРАВЛЕНО: ID темы из ссылки
...
# 🔧 НОВОЕ: Лимит на количество желающих для карт
MAX_WANTERS_FOR_TRADE = 120  # Карты с >= 121 желающими не используются
